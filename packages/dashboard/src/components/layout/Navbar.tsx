              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 glass-card p-2 animate-scale-in origin-top-right">
                  <div className="flex flex-col space-y-1">
                    <Link to="/dashboard" className="flex items-center space-x-2 p-2 text-muted-foreground hover:text-foreground list-item-hover">
                      <User size={16} />
                      <span className="text-sm">Personal Workspace</span>
                    </Link>
                    <Link to="/organizations" className="flex items-center space-x-2 p-2 text-muted-foreground hover:text-foreground list-item-hover">
                      <Users size={16} />
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-card/95 backdrop-blur-md border-b border-border animate-slide-in">
          <div className="container-custom py-4 flex flex-col space-y-4">
            <Link to="/" className="text-sm font-medium p-2 text-muted-foreground hover:text-foreground list-item-hover">
              Home
            </Link>
            <Link to="/features" className="text-sm font-medium p-2 text-muted-foreground hover:text-foreground list-item-hover">
              Features
            </Link>
            <Link to="/docs" className="text-sm font-medium p-2 text-muted-foreground hover:text-foreground list-item-hover">
              Documentation
            </Link>
            ...
            {isAuthenticated ? (
              ...
              <div className="flex flex-col space-y-2 pt-2">
                <Link to="/auth" className="w-full">
                  <Button variant="ghost" className="w-full justify-start text-muted-foreground hover:text-foreground">Sign In</Button>
                </Link>
