...
import ExecutionLogList from '@/components/ui/ExecutionLogList';
...
const projects: Project[] = [
  {
    ...
    description: 'Node.js, npm, and React-related diagnostic scripts for frontend development.',
  ...
  },
  {
    id: 'project-2',
    name: 'Backend Setup',
    description: 'PostgreSQL, Redis, and Node.js backend environment verification.',
    workspaceId: 'personal',
    scriptsCount: 3,
  ...
  },
  {
    ...
    description: 'Scripts to validate CI/CD pipeline tool installations and configurations.',
  ...
  },
  {
    ...
    description: 'Common development environment setup verification for new team members.',
    workspaceId: 'acme-corp',
    scriptsCount: 7,
  ...
  },
  {
    ...
    description: 'Android and iOS development environment setup and verification.',
...
const Dashboard = () => {
  ...
  const filteredProjects = projects.filter(project => project.workspaceId === activeWorkspace.id);
  ...
  const handleCreateProject = (data: { name: string; description?: string }) => {
    ...
    console.log('Creating project:', { ...data, workspaceId: activeWorkspace.id });
              ...
              <div className="relative">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" className="flex items-center space-x-2 h-auto py-2">
            ...
            <Card className="p-8 text-center">
              <CardContent className="py-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Create your first project to start building diagnostic scripts.
                </p>
