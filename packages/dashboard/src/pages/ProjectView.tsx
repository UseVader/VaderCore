...
const scripts: Script[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        shellCommand:
          "ls ~/.config/google-chrome/Default/Extensions | grep -i react",
        type: "CUSTOM",
        scriptId: "script-2",
        order: 1,
      },
  ...
  },
  {
    ...
    description:
      "Check for ESLint and Prettier installations and configurations.",
    projectId: "project-1",
...
const ProjectView = () => {
  ...
  const displayedScripts = filteredScripts.slice(
    startIndex,
    startIndex + scriptsPerPage
  );
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Node.js, npm, and React-related diagnostic scripts for
